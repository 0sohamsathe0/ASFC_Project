...
// Framer Motion exposes a lowercase JSX component namespace.
...
export default function AnalyticsDashboard() {
  ...
  resultData.forEach((section) => {
    ...
    if (Object.prototype.hasOwnProperty.call(medalAnalytics, section.level)) {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen min-w-0 bg-slate-50 px-3 py-5 sm:p-6 lg:p-8"
    >
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex min-w-0 flex-col gap-3 sm:mb-10">
        ...
        >
          <div className="grid gap-6 xl:grid-cols-12">
            ...
            <motion.div
              whileHover={{ y: -4 }}
              className="overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-5 text-white shadow-2xl sm:p-8 xl:col-span-5"
            >
              <div className="flex min-w-0 flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-white/10 backdrop-blur sm:h-24 sm:w-24 sm:rounded-3xl">
                  ...
                  {section.tournaments.map((tournament, index) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full px-4 py-5 text-left sm:px-7 sm:py-6"
                      >
                        ...
                        <div className="flex min-w-0 items-start justify-between gap-3 sm:gap-6">
                          ...
                          <motion.div
                            ...
                            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-slate-100 sm:h-12 sm:w-12"
                          >
                      ...
                      <AnimatePresence>
                        ...
                        {expandedTournament === tournament._id && (
                          ...
                          >
                            ...
                            <div className="space-y-8 px-4 py-5 sm:space-y-10 sm:px-7 sm:py-7">
